      ...
      <section className="py-20">
        <Container className="max-w-5xl">
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,18rem)_1fr] lg:items-start">
            ...
            <div>
              <p className="text-sm font-semibold uppercase tracking-widest text-clap-gold">{member.group}</p>
              <h1 className="mt-3 font-serif text-4xl font-black text-clap-text">{member.name}</h1>
              <p className="mt-2 text-lg font-semibold text-clap-gold">{member.role}</p>
