...
export default function HomeHero() {
  return (
    <section className="relative min-h-[calc(100vh-5rem)] overflow-hidden border-b border-clap-border">
      <div className="absolute inset-0 bg-[linear-gradient(120deg,rgba(15,23,42,0.88),rgba(15,23,42,0.68)),linear-gradient(135deg,rgba(212,175,55,0.18),transparent_35%),url('https://images.unsplash.com/photo-1589391886645-d51941baf7fb?auto=format&fit=crop&w=1800&q=80')] bg-cover bg-center" />
      <Container className="relative flex min-h-[calc(100vh-5rem)] items-center py-16">
        <motion.div variants={fadeIn} initial="hidden" animate="visible" className="max-w-4xl">
          <div className="mb-6 inline-flex items-center gap-2 rounded-md border border-clap-border bg-white/5 px-4 py-2 text-sm font-semibold text-clap-gold">
